function status = mcDockerConfig(varargin)
%Initiate the docker-machine
%
...
% 
% EXAMPLE:
%    [status] = mcConfig('machine', 'default', 'debug', true); 
% 
% (C) Stanford VISTA Lab, 2016 
% NOTE: Move cloud config to a seperate function: cloudConfig.m
